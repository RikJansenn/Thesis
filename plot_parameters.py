...
def plot_parameters_against_measure(measure):
    ...
    #
    # plt.tight_layout()
    # plt.savefig(f"{measure}_vs_parameters")
    # plt.show()
...
if __name__ == "__main__":
    data = pd.read_csv("results_parameters_ip_10_iter.csv")

    measure = "entropy_std"
    # plot_parameters_against_measure(measure)
    # plot_correlation(data, "lr", "sr", "KL_mean")
    ...
    # plt.title("Entropy mean vs entropy std")
    # plt.show()
